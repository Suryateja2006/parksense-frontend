...
const handlePaymentDone = async () => {
  ...
  const fetchQRCode = async (carNumber) => {
    try {
      ...
      const response = await fetch(
        `https://6436-2001-4490-4cac-1cc9-b595-86c5-34f2-2e30.ngrok-free.app/get-qr?plate_number=${encodeURIComponent(carNumber)}&t=${timestamp}`,
        {
          headers: {
  ...
  const handleQRScan = async () => {
    try {
      const response = await fetch("https://6436-2001-4490-4cac-1cc9-b595-86c5-34f2-2e30.ngrok-free.app/check-scan", {
        method: "POST",
      ...
      if (result.status === "released") {
        ...
        const statusResponse = await fetch(
          `https://6436-2001-4490-4cac-1cc9-b595-86c5-34f2-2e30.ngrok-free.app/slot-status?plate_number=${encodeURIComponent(userData.carNumber)}`,
        )
